...
const deliveryModal = new DeliveryForm(ensureElement('.modal__delivery'), eventEmitter, 'delivery')
const contactModal = new ContactForm(ensureElement('.modal__contact'), eventEmitter, 'contact')
